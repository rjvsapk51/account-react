...
const MenuCatalogue = (props: IProp) => {
  const [columnsState] = useState<Array<Column<IMenuModel>>>([
    { title: "Id", field: "id", hidden: true },
    { title: "Banner", field: "banner" },
    { title: "Icon", field: "icon" },
    { title: "Router link", field: "routerLink" },
    { title: "Is active", field: "isActive", type: "boolean" },
    { title: "Description", field: "description" },
  ]);
  const [menuListState, setMenuListState] = useState<IMenuModel[]>([]);
  //populate table on coponent load
  useEffect(() => {
    setMenuListState(props.menuList);
  },[props.menuList,props.isLoading]);
      ...
      <MaterialTable
        ...
        actions={[
          ...
          },
          {
            ...
            position: "toolbar",
            onClick: (event) => {
              handleAnyButtonClick({ menu: {}, action: "create" });
            },
          },
        ]}
